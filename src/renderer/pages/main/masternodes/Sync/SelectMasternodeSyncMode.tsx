        ...
        <Row style={{ marginTop: "120px", marginBottom: "20px" }}>
          <Col span={12} offset={6}>
            <Button onClick={() => navigate("/main/masternodes/syncAssist")} style={{ height: "200px", width: "100%" }}>
              <Row>
                <Col span={24}>
                  <Text style={{ fontSize: "40px" }}>{t("wallet_masternodes_sync_mode_auto")}</Text>
                </Col>
                <Col span={24}>
                  <Text type="secondary" style={{ fontSize: "20px", whiteSpace: "normal" }}>{t("wallet_masternodes_sync_mode_auto_tip")}</Text>
                </Col>
              </Row>
            </Button>
          </Col>
          <Col span={12} offset={6} style={{ marginTop: "100px" }} >
            <Button onClick={() => navigate("/main/masternodes/sync")} style={{ height: "200px", width: "100%" }}>
              <Row>
                <Col span={24}>
                  <Text style={{ fontSize: "40px" }}>{t("wallet_masternodes_sync_mode_manual")}</Text>
                </Col>
                <Col span={24}>
                  <Text type="secondary" style={{ fontSize: "20px", whiteSpace: "normal" }}>{t("wallet_masternodes_sync_mode_manual_tip")}</Text>
                </Col>
              </Row>
            </Button>
          </Col>
