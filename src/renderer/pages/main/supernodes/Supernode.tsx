...
export default ({
    ...
    const items: TabsProps['items'] = [
        ...
        },
        {
            key: '2',
            label: '投票人',
            children: <Members memberInfos={supernodeInfo.voteInfo.voters} />,
        },
    ];
        ...
        <Card title="超级节点详情" style={{ width: "100%", marginTop: "50px" }}>
            <Row>
                <Col span={16}>
                    ...
                    <Row style={{ marginTop: "5px" }}>
                        ...
                        <Col span={18}>
                            <Text strong>{RenderNodeState(supernodeInfo.stateInfo.state)}</Text>
                        </Col>
                    </Row>
                    <Row style={{ marginTop: "5px" }}>
                        <Col span={6}>
            ...
            <Row style={{ marginTop: "5px" }}>
                ...
                <Col span={20}>
                    <Text strong>
                        {
                            supernodeInfo.voteInfo.voters.reduce<CurrencyAmount>(
